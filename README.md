...
## Example Usage
Download 500 images of each `class`, check each is a valid `jpeg`, save to directory `dataset`, create imagenet-type directory structure and create `ImageDataBunch.from_folder(...)`
```
