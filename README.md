...
## Example Usage
Download up to 500 images of each `class`, check each image to be a valid `jpeg`, save to directory `dataset`, create imagenet-type directory structure and create `data = ImageDataBunch.from_folder(...)`
```
